...
class ImprovedNoise {
    private static instance: ImprovedNoise;

    private p: Uint8Array = new Uint8Array( [ 151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,240,21,10,
    ...
    public static getInstance(){
        // constructor not static :/
        if( this.instance == null ){
            this.instance = new ImprovedNoise();
        }
